...
export const createUser = async (name: string, phone_number: string, role_id: number) => {
  const result = await db.query(`
...
export const updateUser = async (id: number, fields: Partial<{ name: string, phone_number: string, role_id: number }>) => {
