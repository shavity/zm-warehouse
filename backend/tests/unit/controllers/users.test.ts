...
describe('Users Controller - Unit Tests', () => {
    ...
    describe('getUsers', () => {
        ...
        it('should return 500 if database fails', async () => {
            (usersDal.getAllUsers as jest.Mock).mockRejectedValue(
                new Error('DB error')
            );
            const req = mockRequest();
            const res = mockResponse();
    ...
    describe('getUser', () => {
        ...
        it('should return 500 if database fails', async () => {
            (usersDal.getUserById as jest.Mock).mockRejectedValue(
                new Error('DB error')
            );
            const req = mockRequest({}, { id: '1' });
            const res = mockResponse();
    ...
    describe('editUser', () => {
        it('should return updated user', async () => {
            ...
            (usersDal.updateUser as jest.Mock).mockResolvedValue({
                ...fakeUser,
                name: 'Yair Updated',
            });
        ...
        it('should return 500 if database fails', async () => {
            (usersDal.updateUser as jest.Mock).mockRejectedValue(
                new Error('DB error')
            );
    ...
    describe('removeUser', () => {
        ...
        it('should return 500 if database fails', async () => {
            (usersDal.getUserById as jest.Mock).mockResolvedValue(fakeUser);
            (usersDal.deleteUser as jest.Mock).mockRejectedValue(
                new Error('DB error')
            );
            const req = mockRequest({}, { id: '1' });
            const res = mockResponse();
